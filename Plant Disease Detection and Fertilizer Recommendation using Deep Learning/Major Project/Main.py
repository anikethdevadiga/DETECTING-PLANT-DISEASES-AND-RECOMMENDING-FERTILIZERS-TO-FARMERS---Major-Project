...
# Removed the call to _make_predict_function

main = tkinter.Tk()
main.title("Developing An Integrated System For Detecting Plant Diseases And Recommending Fertilizers to Farmers") #designing main screen
...
def runSVM():
    ...
    # Always retrain the model with probability=True
    svm_cls = svm.SVC(probability=True)  # Enable probability estimates
    svm_cls.fit(X, Y)
...
font = ('times', 16, 'bold')
title = Label(main, text='Developing An Integrated System For Detecting Plant Diseases And Recommending Fertilizers to Farmers')
